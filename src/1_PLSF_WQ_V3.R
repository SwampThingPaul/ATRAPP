...
vars1=c("TP.ugL", "SRP.ugL", "DP.ugL", "PP.ugL","DOP.ugL","Cond","ORP.mV")
...
paramvars=c("TP.ugL","PP.ugL", "DP.ugL", "SRP.ugL", "DOP.ugL",
            ...
            "TN_TP","DIN_SRP","PP_TP","DP_TP","SRP_TP","NH4_TN","NOx_TN",
            "Cond","DO.per","Colour_PCU","Secchi_cm","Temp.C","pH","Phyco.ugL", "TChl.ugL")
